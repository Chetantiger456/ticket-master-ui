...
import { startAddTicket, startEditTicket } from '../../actions/ticketsAction'
        ...
        return (
            <div>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <textarea value={this.state.message} onChange={this.handleChange} name="message" id="message"></textarea> <br/>
